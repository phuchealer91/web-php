<div id="divLogin" class="modal">
  <form class="modal-content animate" method="POST">
    <div class="imgcontainer"> <span onclick="document.getElementById('divLogin').style.display='none'" class="close" title="Close Modal">&times;</span> <img src="images/logo.png" alt="logo" class="avatar"> </div>
    <div class="containerLogin">
	  ...
	  $matKhau;
		if(isset($_POST["buttonDangNhap"])){
			...
			$matKhau = $_POST["psw"];
			$query_login = "select * from TaiKhoan where ten_dang_nhap ='".$tenDangNhap."' and mat_khau = '".$matKhau."'";
