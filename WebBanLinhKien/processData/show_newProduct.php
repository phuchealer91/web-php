...
{
	$query_tbProduct = "SELECT * FROM HangHoa where  san_pham_moi = 1";
    ...
    ?>
  	...
  	<div class="productinfo text-center"> 
    	<a  href='product.php?ma_san_pham=<?php echo $row["ma_san_pham"] ?>'>
            <img src="images/san_pham/<?php echo $row["hinh"] ?>"  alt="<?php echo $row["hinh"] ?>" /> </a>
...
{
	$query_tbProduct = "SELECT * FROM HangHoa where ma_loai= ".$_REQUEST["ma_loai"];
  $tbProduct= $dbQuanLyBanLinhKien->query($query_tbProduct);
  echo" <section id='spBanMoi' class='feildContent'>
