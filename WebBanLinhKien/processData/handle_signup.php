<?php
	if(isset($_POST['buttonDangKy'])){
		...
		$query_tenDangNhap = 'select * from TaiKhoan where ten_dang_nhap = "'.$tenDangNhapDK.'"';
		...
		$query_email = 'select * from TaiKhoan where email ="'.$emailDK.'"';
		...
		$query_newUser = "INSERT INTO TaiKhoan ( ho_ten, ten_dang_nhap, mat_khau, email, dia_chi) VALUES ('".$hoTenDK."', '".$tenDangNhapDK."', '".$passDK."', '".$emailDK."', '".$diaChiDK."')";
