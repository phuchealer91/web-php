...
{
	$query_tbProduct = "SELECT * FROM HangHoa ";
...
{
	$query_tbProduct = "SELECT * FROM HangHoa where ma_san_pham= ".$_REQUEST["ma_san_pham"];
  $tbProduct= $dbQuanLyBanLinhKien->query($query_tbProduct);
  echo" <section id='chiTiet' class='feildContent'>
	...
	$query_tbProductDifferent = "SELECT * FROM HangHoa where  ma_loai= ".$maloai." AND ma_san_pham <>".$_REQUEST["ma_san_pham"];
